...
class UploadFile():
    ...
    def upload(self, params, startTime):
        ...
        for param in params:
            respons = requests.request(method="GET", url="http://192.168.4.37:8310/user/jwt/time")
...
if __name__ == '__main__':
    t = [{"fileType": "原始影像", "filepath": "\\\\192.168.49.40\\测试部共享\\测试数据\\iCenter1.1\\GF2_PMS1_E108.0_N33.7_20161002_L1A0001862272.tar.gz"},
    ...
    uploadFile = UploadFile("192.168.4.37", "8310", "sundi", "sundi")
    uploadFile.upload(t,"20200103113300")
